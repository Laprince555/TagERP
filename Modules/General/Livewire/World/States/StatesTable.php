...
/**
 * Real production States index for the "gen-wld-sta" Application
 * (general.world.states), reusing the package State model/table and the
 * Dynamic Table engine.
 */
class StatesTable extends Table
{
    protected string $tableKey = 'general-world-states';
