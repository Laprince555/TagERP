 ...
 * record-reference concern for City: title, route, facts, and scoping.
 */
class CityRecordReferenceProvider implements RecordReferenceProvider
{
    ...
    {
        return route('general.world.cities.show', ['recordId' => $record->getKey()]);
    }
    ...
    /**
     * Cities carry no active/inactive flag — every seeded City is
