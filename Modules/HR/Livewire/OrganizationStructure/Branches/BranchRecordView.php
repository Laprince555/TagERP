...
/**
 * Reachable page for the Branch show route (hr.organization-structure.branches.show).
 * Thin adapter only — behavior lives in App\Livewire\DynamicRecordView\RecordView.
 */
#[Layout('layouts.app', ['showBreadcrumbs' => false])]
class BranchRecordView extends RecordView
{
    ...
    {
        return 'hr.organization-structure.branch';
    }
}
