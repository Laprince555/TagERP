...
/**
 * Reachable page for the Employee show route (hr.employee-management.employees.show).
 * Thin adapter only — behavior lives in App\Livewire\DynamicRecordView\RecordView.
 */
#[Layout('layouts.app', ['showBreadcrumbs' => false])]
class EmployeeRecordView extends RecordView
{
    ...
    {
        return 'hr.employee-management.employee';
    }
}
