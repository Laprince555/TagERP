...
/**
 * Reachable page for the Allocation show route. Thin adapter only.
 */
#[Layout('layouts.app', ['showBreadcrumbs' => false])]
class AllocationRecordView extends RecordView
{
    ...
    {
        return 'inventory.stock-movements.allocation';
    }
}
