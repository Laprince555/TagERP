...
return new class extends Migration
{
    ...
    {
        Schema::create('finance_ap_invoice_tax_lines', function (Blueprint $table) {
            $table->id();
            ...
            // Set when this tax line applies to a single cost center rather
            // than following the invoice-level allocation.
    ...
    {
        Schema::dropIfExists('finance_ap_invoice_tax_lines');
    }
};
