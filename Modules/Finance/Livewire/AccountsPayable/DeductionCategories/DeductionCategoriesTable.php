...
/**
 * Deduction Categories index for the "fin-ap-dcc" Application
 * (finance.accounts-payable.deduction-categories).
 */
class DeductionCategoriesTable extends Table
{
    protected string $tableKey = 'finance-accounts-payable-deduction-categories';
    ...
    protected function query(): Builder
    {
        ...
        if (! app(RecordReferenceAccess::class)->applicationAccessible($application)) {
            return DeductionCategory::query()->whereKey(-1);
        }
    ...
    {
        return 'finance.accounts-payable.deduction-category.create';
    }

    protected function createFormLabel(): string
    {
        return __('Add Deduction Category');
    }
}
