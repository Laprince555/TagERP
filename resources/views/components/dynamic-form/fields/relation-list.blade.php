...
<div wire:key="relation-list-{{ $formKey }}-{{ $fieldKey }}">
    ...
    @if ($isOpen)
        ...
        <div
            class="fixed left-1/2 top-1/2 z-[9999] w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 space-y-2 overflow-y-auto rounded-xl border border-app bg-card p-4 shadow-2xl"
