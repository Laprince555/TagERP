...
>
    ...
    >
        <span class="inline-flex size-8 items-center justify-center rounded-full border border-zinc-200 dark:border-zinc-700 bg-black/5 hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10">
